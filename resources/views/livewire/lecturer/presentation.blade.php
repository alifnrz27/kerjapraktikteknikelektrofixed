                                                                ...
                                                                <div class="w-full p-4 bg-white rounded-lg max-h-[650px] overflow-hidden">
                                                                    ...
                                                                    <section class="pt-20 pb-20 max-h-[650px] flex justify-center">
                                                                        <div style="padding:40px;width:500px">
                                                                            <form wire:submit.prevent="confirmAcceptPresentationStudent({{ $p->user->id }}, {{ $p->id }})">
                                                                                <div class="w-full lg:mx-auto">
                                                                                    <div class="w-full mb-8 px-4">
                                                                                        <label for="date_presentation" class="text-base text-primary font-bold">Waktu*</label>
                                                                                        <input type="datetime-local" id="date_presentation" name="date_presentation" wire:model.lazy="date_presentation" class="w-full bg-slate-200 text-dark p-3 rounded-md focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary">
