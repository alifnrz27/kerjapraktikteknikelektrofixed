                                        ...
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 flex">
                                            ...
                                            <div
                                                ...
                                                <div x-cloak x-show="open" x-transition class="fixed top-0 left-0 w-full h-screen bg-black/50 flex justify-center items-center">
                                                    <section @click.outside="open = false" id="decline-before-presentation-{{ $b->user->username }}" class="fixed w-full lg:w-4/12 p-3 mb-5 mx-auto my-auto dark:bg-dark shadow-lg bg-primary" style="margin: auto">
