                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b">
                                        ...
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 flex">
                                            <button title="terima" type="button" wire:click="acceptConfirm('{{$s->user->username}}', {{$s->team_id}})">
                                            ...
                                            <div x-data={open:false}>
                                                ...
                                                <div x-cloak x-show="open" x-transition class="fixed top-0 left-0 w-full h-screen bg-black/50 flex justify-center items-center">
                                                    <section @click.outside="open = false" class="fixed  w-full lg:w-4/12 p-3 mb-5 mx-auto my-auto dark:bg-dark shadow-lg bg-primary" style="margin: auto">
                                                        <div class="w-full p-4 bg-white dark:bg-secondary rounded-lg h-full max-h-[1000px] overflow-auto">
                                                            ...
                                                            <section class="pt-36 pb-32 dark:bg-slate-900">
                                                                <div class="container">        
                                                                    <form wire:submit.prevent="declineConfirm('{{$s->user->username}}', {{$s->team_id}})">
